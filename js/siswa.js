...
(function () {
  ...
  const students = [
    ...
    { no: 3, name: "Aldo Riezky Erlangga Nst", gender: "L" },
    { no: 4, name: "Anggi Ramahdani", gender: "P" },
    { no: 5, name: "Aprilya Kristiana Simangunsong", gender: "P" },
    { no: 6, name: "Arinny Kahilah Hadi", gender: "P" },
    { no: 7, name: "Asyifah Septiani", gender: "P" },
    { no: 8, name: "Bentio Alfarabi", gender: "L" },
    { no: 9, name: "Bilva Aulia Syalyani", gender: "P" },
    { no: 10, name: "Bima Damanik", gender: "L" },
    { no: 11, name: "Bima Sakti Tarigan", gender: "L" },
    { no: 12, name: "Bintang Aya Al-Qadr", gender: "L" },
    {
      no: 13,
    ...
    { no: 14, name: "Celsie Angel Br. Haloho", gender: "P" },
    { no: 15, name: "Cinta Uli Natasya Br Manullang", gender: "P" },
    { no: 16, name: "Clarissa Dewi Mazaya", gender: "P" },
    { no: 17, name: "Dina Maria Br Silalahi", gender: "P" },
    { no: 18, name: "Dwi Diandry Saputri", gender: "P" },
    { no: 19, name: "Erlina Sriwani Gultom", gender: "P" },
    { no: 20, name: "Genta Mulia Marbun", gender: "L" },
    { no: 21, name: "Helen Seberia Rotua Simanjuntak", gender: "P" },
    { no: 22, name: "Indri Yani Sinaga", gender: "P" },
    { no: 23, name: "Jhoni Cristian Nduru", gender: "L" },
    { no: 24, name: "Kenzi Rafha Fahwas", gender: "L" },
    { no: 25, name: "Kesila Zahra", gender: "P" },
